...
MvcCore Router extension to manage multiple websites in single project and to manage website media versions (full/tablet/mobile) for different templates/css/js files rendering, optionaly contained in url address in the beinning.  
